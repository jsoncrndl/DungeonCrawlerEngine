...
namespace Engine::Graphics
{
	...
	public:
		...
		void freeShaders(std::shared_ptr<Resources::Registry<Shader, Resources::ShaderImporter>> registry);;

		void loadTextures(std::shared_ptr<Resources::Registry<Texture, Resources::TextureImporter>> registry);
		void freeTextures(std::shared_ptr<Resources::Registry<Texture, Resources::TextureImporter>> registry);;
